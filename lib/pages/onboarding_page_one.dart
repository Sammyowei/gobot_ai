...
class OnboardingPageOne extends ConsumerStatefulWidget {
  const OnboardingPageOne({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _OnboardingPageOneState();
}

class _OnboardingPageOneState extends ConsumerState<OnboardingPageOne> {
  @override
